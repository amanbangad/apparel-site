...
export default function ProductPage({ params }: ProductPageProps) {
  ...
  useEffect(() => {
    // Ensure the pixel has loaded before tracking
    ...
    // Try to track immediately, but also set a fallback
    trackProductView()

    // Also track after a delay to ensure pixel is loaded
        ...
        >
          <div className="border-b">
            <div className="flex overflow-x-auto">
              ...
              <button
                className={`px-4 py-2 font-medium transition-all ${activeTab === "reviews" ? "border-b-2 border-primary" : "text-muted-foreground hover:text-foreground"}`}
