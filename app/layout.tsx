...
import PixelChecker from "@/components/pixel-checker"
import PixelDebugButton from "@/components/pixel-debug-button"
    ...
    <html lang="en">
      ...
      <body className={inter.className}>
        <CartProvider>
          ...
          {process.env.NODE_ENV === "development" && <PixelDebugButton />}
          <PerformanceMonitor />
          <ResourcePreloader />
          <PWAInstallPrompt />
        </CartProvider>
